...
if __name__ == "__main__":
    ...
    configdocs = custom.retrieve_data_from_db_with_host_input(int(config.ConfigManager().MongoDBPort),config.ConfigManager().DataCollectionDB,config.ConfigManager().ConfigCollection, config.ConfigManager().ExternalHost)
#     # nounphrase_generate()
